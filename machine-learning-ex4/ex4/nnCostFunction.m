...
z3 = Theta2*a2;
a3 = sigmoid(z3);
J_unreg = trace(-Y*log(a3) - (1-Y)*log(1-a3))/m;
...
Theta1_grad = [Delta1(:, 1)/m, Delta1(:, 2:end)/m + lambda*Theta1(:, 2:end)/m];
Theta2_grad = [Delta2(:, 1)/m, Delta2(:, 2:end)/m + lambda*Theta2(:, 2:end)/m];
